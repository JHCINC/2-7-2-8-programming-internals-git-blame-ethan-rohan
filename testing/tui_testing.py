...
def main(stdscr):
    ...
    #clears screen
    stdscr.clear() 
    #prints/adds the "Hello, I am using Curses!" Underline?
    stdscr.addstr(0,0, "Hello, I am using Curses!", curses.color_pair(1))
    #refreshes everthing
    stdscr.refresh()
    #This while loop checks of the "l" key to be pressed and then changes the beginniong of the text to HELLO1
    while True:
        key = stdscr.getch()
        if key == ord("l"):
